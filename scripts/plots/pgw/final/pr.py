...
if __name__ == '__main__':
    ...
    # # Create spatial map
    # pgw = PGW(filename='pr_SRF.nc', val_min=0, val_max=680, val_modify_func=mod_pr, 
    ...
    pgw = PGW(filename='pr_SRF.nc', val_min=0, val_max=10, val_modify_func=mod_pr, path_mask='data/shp/mask_aceh.nc',
            unit=r'Precipitation (mm h$^{-1}$)',
            var_name='pr', time_start="2025-11-25", time_end="2025-11-26",
            time_stat=None, ens_stat='mean')
    
    pgw.plot_dist_change(change_val_min=5, change_val_max=90, add_cc_limit=True, pct=0.99,
