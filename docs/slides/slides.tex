...
\begin{frame}
    \begin{itemize}
        ...
        \end{equation} 
        with $m$ represents each experiment with the corresponding $m$-th perturbation or climate model forcing. \pause
        ...
        \end{equation} \pause
        \item The Clausius-Clapeyron scaling analysis is done to study the response of the variables to global warming level change between the factual and counterfactual simulation. We divide $X_{\text{increase}}$ in Eq. \eqref{eq:increase-1} and \eqref{eq:increase-2} with 1.5$^\circ$ which corresponds to the experiment design.
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \vspace{0.5cm}
    \begin{itemize}
        \item Short-duration extremes are intensifying at Clausius-Clapeyron (CC) rates or exceeding it due to \textbf{thermodynamic and dynamical feedbacks} \citep{fowler2021}.
...
\begin{frame}
    \centering{\textbf{Moisture Transport}}
    \begin{figure}[ht]
        \centering
        \begin{subfigure}{0.7\textwidth}
            \centering
...
\begin{frame}
    \centering{\textbf{Convective Available Potential Energy (CAPE)}}
    \begin{figure}[ht]
        \centering
        \begin{subfigure}{0.7\textwidth}
            \centering
...
\begin{frame}
    \centering{\textbf{Latent Heating Rate}}
    \begin{figure}[ht]
        \centering
        \begin{subfigure}{0.7\textwidth}
            \centering
...
\begin{figure}[ht]
    \centering{\textbf{Maximum Vertical Velocity}}
    \centering
    \begin{subfigure}{0.7\textwidth}
        \centering
