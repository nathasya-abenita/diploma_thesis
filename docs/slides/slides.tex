...
\begin{frame}
    ...
    \begin{block}{Track definition}
        At each time step, the track is defined at a coordinate with the lowest sea level pressure.
    \end{block}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{block}{Steps in applying PGW}
        \begin{enumerate}
            ...
            \item Compute perturbation. For example, "cooling" perturbation for EC-Earth3-Veg is 
...
\begin{frame}
    \centering
    {
    \includegraphics[width=0.8\textwidth]{../../figs/compare/ts_complete.png}
...
\begin{frame}
    \begin{itemize}
        ...
        \item To evaluate anthropogenic influence, the rate of increase from \textbf{past to present} is computed by
        ...
        \item Similarly, the rate of increase from \textbf{present to future} is computed by
...
\begin{frame}
    ...
    \vspace{-0.1cm}
    {
    \scriptsize Track comparison between ERA5 and observation from IBTrACS
    }
    }
    \newline
    \begin{itemize}
...
\begin{frame}
    ...
    {
    % \vspace{-0.5cm}
    \includegraphics[width=0.9\textwidth]{../../figs/compare/tas_complete.png}
...
\begin{frame}
    ...
    {
    % \vspace{-0.5cm}
    \includegraphics[width=0.5\textwidth]{../../figs/dynamical/zg500_all_model.png}
...
\begin{frame}
    \begin{block}{Future directions}
        \begin{itemize}
            ...
            \item Extending the study to an extreme case, e.g +3.0$^\circ$ global warming level
        \end{itemize}
    \end{block}
\end{frame}
