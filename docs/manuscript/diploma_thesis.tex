...
\title{Anthropogenic Influences on the 2025 Sumatra Flash Floods and Tropical Cyclone Senyar}
...
\author{
    ...
    \\
    \small\it A project \\
    \small\it submitted in partial fulfillment of the requirements\\
    \small\it for the Postgraduate Diploma at ICTP \\
    \\
    \small Supervised by: \\
    \small Erika Coppola\\
    \small Maria Leidinice da Silva
    }
\date{
  \begin{center}
    \vspace{0.5cm}
    \includegraphics[width=3cm]{../figs/ICTP_logo.eps}
    \vspace{0.5cm}
  \end{center} 
  \small The Abdus Salam International Centre for Theoretical Physics (ICTP) \\
  \small August 2026 
  }
...
\input{chapter2.tex} % Chapters might go from 2. problem statement, 
%                  % through 3. model, to 4. analysis & results
\input{chapter3.tex} % You do not need to have exactly 4 chapters.
...
\renewcommand{\theHchapter}{\Alph{chapter}\arabic{section}}
\makeatother
\input{appendix}
%-----------------------------------------------------------------------------
\end{document}
