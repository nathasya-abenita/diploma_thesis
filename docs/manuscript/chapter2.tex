...
The perturbation is quantified by computing the difference between two long-term monthly mean climate periods: (i) 1850--1900 as pre-industrial climate and a 20-year period corresponding to 1.5$^\circ$ as present climate or (ii) present climate and the future climate with 3$^\circ$ of global warming level (GWL). A summary of these periods can be seen in Table \ref{table:cmip6}. By choosing a long climatic period, we also reduce effects from internal variability as a common strategy in PGW method \citep{brogli2023pseudo}. Furthermore, the CMIP6 historical experiment is concatenated with the SSP3-7.0 scenario when needed to construct the period for GWL 1.5$^\circ$ or $3^\circ$. By this, we define the perturbation as
