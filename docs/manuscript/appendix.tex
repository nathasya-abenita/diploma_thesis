...
ERA5 data can be accessed through \url{https://10.24381/cds.adbb2d47} and \url{https://doi.org/10.24381/cds.bd0915c6}. RegCM namelists and Python scripts are stored in \url{https://github.com/nathasya-abenita/diploma_thesis}. Daily rainfall from local stations can be accessed through \url{https://dataonline.bmkg.go.id/}, a website managed by Indonesian Meteorology, Climatology, and Geophysical Agency (BMKG). 
...
\chapter{Comparison of Simulated and Observed Daily Rainfall}
