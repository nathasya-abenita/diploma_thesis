...
\begin{itemize}
    ...
    \item In a +1.5$^\circ$ warmer world, the hazard may become more spatially concentrated but significantly more violent. While heavy rainfall intensity continues to increase (+8\%), exceeding Clausius-Clapeyron scaling, the total rainfall and total rainfall area are projected to contract by 9\% and 15\%, respectively.
